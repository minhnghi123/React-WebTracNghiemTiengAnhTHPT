      ...
      <Tabs defaultActiveKey="1" type="card">
        ...
        <Tabs.TabPane tab="Danh sách câu hỏi" key="1">
          <div style={{ display: "flex", gap: "16px" }}>
            ...
            <div style={{ flex: 1 }}>
              <h3 style={{height:"100px", textAlign:"center",justifyContent:"center"}}>Danh sách câu hỏi trong đề thi</h3>
              <div
                style={{
            ...
            <div style={{ flex: 1 }}>
              <div  style={{height:"100px", textAlign:"center",justifyContent:"center"}}>
